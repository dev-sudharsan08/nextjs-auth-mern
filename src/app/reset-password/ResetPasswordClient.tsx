...
const ResetPasswordClient: React.FC<PasswordProps> = ({ token }) => {
          ...
          {isPasswordReset ? (
            ...
            <>
              ...
              <form className='space-y-6' onSubmit={handleResetPassword}>
                <PasswordInput id='newPassword' name='newPassword' label='Password' placeholder='Enter your new password' value={password.newPassword} error={formErrors.newPassword} onChange={handleChange} />
                <PasswordInput id='confirmPassword' name='confirmPassword' label='Confirm Password' placeholder='Re-enter your new password' value={password.confirmPassword} error={formErrors.confirmPassword} onChange={handleChange} />
                <div className='text-center pt-4'>
                  <button type='submit' className='w-full bg-gradient-to-r from-blue-600 to-sky-600 hover:from-blue-700 hover:to-sky-700 text-white font-bold py-3 px-6 rounded-xl shadow-2xl transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-1 focus:ring-blue-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 group' disabled={!password.newPassword.trim() || !password.confirmPassword.trim()}>
